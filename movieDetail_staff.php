            ...
            <div class="row my-5">
                <div class="col-lg-8">
                    ...
                    <div class="w-75 mx-auto">      
                        ...
                        <p class="lead">Rated-R: <?php echo $row['rated_r'] ?></p>
                        <p class="lead">Cast: <?php echo $row['cast'] ?></p>
                        <p class="lead">Directed by: <?php echo $row['directors'] ?></p>
                        <p class="lead d-inline">Rate: <i class="fas fa-star"></i> <?php foreach($avg as $row2){ echo round($row2['averageRate'],1); } ?> / 10</p>  
                            <?php if($row['moviecategory_id'] == '2'): ?>
                                <a href="review_staff.php?movie_id=<?php echo $row['movie_id'] ?>" class="ml-3">Review >></a> 
                            <?php endif ?>
                        <br>
                        <a href="movieTimeline_staff.php?movie_id=<?php echo $row['movie_id'] ?>" role="button" class="btn btn-danger mt-4">Reserve Ticket</a>
                    </div>
                </div>
