      ...
      <div class="row">
        <div class="col-lg-12 mt-2">
          <ul class="nav nav-tabs text-center">
            ...
            <li class="nav-item">
              <a class="nav-link" href="theater4_staff.php?theater_id=<?php echo $theaterID ?>"><?php echo date('D', strtotime(' +3 day')) ?><br><?php echo date('M d', strtotime(' +3 day')) ?></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link active"><?php echo date('D', strtotime(' +6 day')) ?><br><?php echo date('M d', strtotime(' +6 day')) ?></a>
            </li>
          </ul>
        </div>
      </div>
              ...
              <table width="200" height="100" class="table">
                ...
                <tbody>
                  <tr class="font-weight-bold">
                    ...
                    <td colspan="2"><?php foreach($price as $row){ echo $row['price']; } ?>P</td>
                  </tr>
                  <tr>
                    <?php foreach($time as $row): ?>
                      <td><a href="reserve_staff.php?time_id=<?php echo $row['time_id'] ?>" role="button" class="btn text-dark"><?php echo $row['startinghours']; echo ':'; echo $row['startingminutes']; echo $row['startingam/pm']; ?></a></td>
                    <?php endforeach ?>
                  </tr>
                </tbody>
              </table>
