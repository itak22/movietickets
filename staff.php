...
<html lang="en">
  ...
  <body class="customer">
    ...
    $oneReserveA = $Movie->viewReserveA();
    ...
    ?>
      <div class="container-fluid">
          ...
          <table class="table w-75 mx-auto">
            ...
            <?php foreach($oneReserveA as $row):
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p class="text-center">Are you sure to cancel the reservation?</p>
                        </div>
                        <div class="modal-footer">
                           <form action="action.php" method="post">
                               <div class="form-group">
                                    <input type="hidden" name="reserveid" value="<?php echo $row['reserve_id'] ?>">
                                    <button type="submit" name="deleteReserveA" class="btn btn-warning mt-3">Yes</button> 
                               </div>
                           </form>
