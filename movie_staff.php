...
<html lang="en">
  ...
  <body class="movie">
    ...
    <div class="container-fluid">
        ...
        <a href="" class="float-right mt-2 mr-5">See All</a>
        <p class="lead font-weight-bold mt-2 float-left"><?php echo $row['moviecategory'] ?></p>
        <a href="#add<?php echo $row['moviecategory_id'] ?>" data-toggle="modal" role="button" class="btn btn-primary mt-2 ml-4">+Add</a>
        <div class="modal fade" id="add<?php echo $row['moviecategory_id'] ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5>Add <?php echo $row['moviecategory'] ?></h5>
                    ...
                    <div class="modal-body">
                        <form action="action.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <input type="hidden" name="mcategory" value="<?php echo $row['moviecategory_id'] ?>">
                                ...
                                <textarea name="overview" id="" cols="30" rows="10" class="form-control"></textarea>
                                ...
                                <input type="text" name="rrate" class="form-control">
