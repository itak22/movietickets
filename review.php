            ...
            <p class="lead">User Rating</p>
                <div class="ml-4">   
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo count($viewRate10)*100/count($viewReview) ?>%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><?php echo round(count($viewRate10)*100/count($viewReview),0) ?>%</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo count($viewRate9)*100/count($viewReview) ?>%;"><?php echo round(count($viewRate9)*100/count($viewReview),0) ?>%</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo count($viewRate8)*100/count($viewReview) ?>%;"><?php echo round(count($viewRate8)*100/count($viewReview),0) ?>%</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo count($viewRate7)*100/count($viewReview) ?>%;"><?php echo round(count($viewRate7)*100/count($viewReview),0) ?>%</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo count($viewRate6)*100/count($viewReview) ?>%;"><?php echo round(count($viewRate6)*100/count($viewReview),0) ?>%</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo count($viewRate5)*100/count($viewReview) ?>%;"><?php echo round(count($viewRate5)*100/count($viewReview),0) ?>%</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo count($viewRate4)*100/count($viewReview) ?>%;"><?php echo round(count($viewRate4)*100/count($viewReview),0) ?>%</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo count($viewRate3)*100/count($viewReview) ?>%;"><?php echo round(count($viewRate3)*100/count($viewReview),0) ?>%</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo count($viewRate2)*100/count($viewReview) ?>%;"><?php echo round(count($viewRate2)*100/count($viewReview),0) ?>%</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="progress mt-1">
                                <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo count($viewRate1)*100/count($viewReview) ?>%;"><?php echo round(count($viewRate1)*100/count($viewReview),0) ?>%</div>
                            </div>
                        </div>
                        <div class="col-md-3">
